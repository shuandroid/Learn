...
constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    init {
        ...
        textColor = typedArray.getColor(
            R.styleable.TagViewStyle_tagTextColor,
            context.resources.getColor(R.color.GBK05A)
        )
        ...
        tagBackground = typedArray.getResourceId(
            R.styleable.TagViewStyle_tagBackground,
            R.drawable.tag_default_bg
        )
